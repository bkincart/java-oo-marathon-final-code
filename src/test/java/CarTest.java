...
public class CarTest {
  ...
  @Test
  @DisplayName("A Car inherits from Automobile")
  public void init_car_inherits_automobile() {
    Assertions.assertTrue(car.getClass() == Car.class);
  }
  ...
  @Test
  @DisplayName("addPassengers cannot load past capacity")
  public void addPassengers_cannot_load_past_capacity_return(){
    Assertions.assertEquals(false, this.car.addPassengers(5));
  }
